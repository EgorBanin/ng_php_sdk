...
EOT
    ...
    public function testOneAppHtmlCode() {
        $this->assertEquals(
            '<script type="text/javascript" src="http://api2.nextgame.ru/iframe/js/link?site_id=7&app_id=166&linktype=1"></script>',
    ...
    public function testAuthOneAppHtmlCode() {
        ...
        $this->assertEquals(
            '<script type="text/javascript" src="http://api2.nextgame.ru/iframe/js/link?site_id=7&app_id=166&linktype=1&user_id=123&usr_nickname=admin&t=token&sig='
                .md5('app_id=166linktype=1site_id=7t=tokenuser_id=123usr_nickname=admin0123456789ABCDEF')
                .'"></script>',
